...
const techStacks = [
  ...
  { icon: "spring.svg", language: "Java Spring Boot" },
  { icon: "github.svg", language: "GitHub" },
  { icon: "gitlab.svg", language: "GitLab" },
  { icon: "opencode.svg", language: "opencode" },
  { icon: "deepseek.svg", language: "DeepSeek" },
  { icon: "claude.svg", language: "Claude Code" },
  { icon: "jira.svg", language: "Jira" },
  { icon: "confluence.svg", language: "Confluence" },
  { icon: "bitbucket.svg", language: "Bitbucket" },
